        ...
        <section className="space-y-6">
          ...
          <section className="rounded-lg border border-gray-200 bg-white p-2 w-full grid grid-cols-9 gap-6 items-center">
            <div className="col-span-6">
              ...
              <h3 className="font-semibold text-zikoroBlack text-xl mb-1">
                Directory
              </h3>
              <p className="text-sm text-zikoroGray mb-4">
                showcase verified members in a searchable, professional
            ...
            <div className="rounded-lg border border-gray-200 bg-white col-span-6 p-4 space-y-4">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="flex-[60%] space-y-4 text-sm">
                  ...
                  {recentCertificate && assignedCertificates?.length === 0 && (
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <BsInfoCircle size={20} className="text-red-600" />
                        <span className="text-xs text-gray-500">
